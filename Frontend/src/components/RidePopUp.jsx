...
const RidePopUp = (props) => {
  const acceptedSound = useRef(null);

  // create once
  if (!acceptedSound.current) {
    acceptedSound.current = new Audio("/src/assets/sounds/incoming.mp3");
  }

  const handleClose = () => {
    props.setridePopUppanel(false);

    acceptedSound.current.currentTime = 0;
    acceptedSound.current.play().catch(() => {});
  };
      ...
      <div className="flex flex-col justify-between items-center w-full">
        ...
        <div className="w-full flex justify-between items-center">
          <button
            ...
            className="bg-green-600 text-white font-semibold rounded-lg p-3 px-8 mt-5"
          >
            Accept
          </button>
          ...
          <button
            ...
            className="bg-gray-300 text-gray-700 font-semibold rounded-lg p-3 px-8 mt-2"
          >
            Ignore
          </button>
        </div>
