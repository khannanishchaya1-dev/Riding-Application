...
const RidePopUp = (props) => {
  return (
   ...
   <h5 className="p-1 text-center absolute w-[90%] top-0"><i onClick={()=>props.setridePopUppanel(false)} className="ri-arrow-down-s-line text-3xl text-gray-400"></i></h5>
        ...
        <div className='w-full'>
          <div className='flex items-center gap-5 p-3 border-b-2  border-gray-300'>
            ...
            <div className='flex flex-col'>
              ...
              <p className='text-sm text-gray-500'>{props.ride?props.ride.origin:null}</p>
            </div>
          </div>
          <div className='w-full'>
            <div className='flex items-center gap-5 p-3 border-b-2  border-gray-300'>
            ...
            <div className='flex flex-col'>
              ...
              <p className='text-sm text-gray-500'>{props.ride?props.ride.destination:null}</p>
            </div>
          </div>
          </div>
          <div className='w-full flex items-center gap-5 p-3'>
           ...
           <div className='flex flex-col'>
              <h3 className='text-lg font-medium'>{props.ride?props.ride.fare:null}</h3>
        ...
        <button onClick={() =>{ props.setconfirmridePopUppanel(true);props.confirmRide()}} className=" bg-green-600 text-white font-semibold rounded-lg p-3 px-8 mt-5">Accept</button>
