...
const VehiclePanel = (props) => {
  return (
    <>
        ...
        <div onClick={()=>props.setconfirmRidepanel(true)}className="flex items-center justify-between w-full p-3 active:border-black border-2 rounded-lg mb-2">
          ...
          <div className="text-xl font-semibold"><h2>$190.97</h2></div>
        </div>
        <div onClick={()=>props.setconfirmRidepanel(true)} className="flex items-center justify-between w-full p-3 active:border-black border-2 rounded-lg mb-2">
          ...
          <div className="text-xl font-semibold"><h2>$65.97</h2></div>
        </div>
         <div onClick={()=>props.setconfirmRidepanel(true)} className="flex items-center justify-between w-full p-3 active:border-black border-2 rounded-lg mb-2">
          ...
          <div className="text-xl font-semibold"><h2>$118.97</h2></div>
        </div>
